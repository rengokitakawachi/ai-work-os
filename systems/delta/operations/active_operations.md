...
version: baseline_preserved_delay_adjustment_after_2026_05_05
updated_at: 2026-05-05
branch: feature/atlas-pre-delta-foundation
operation_status: active_next_baseline_preserved_delay_adjusted
...
existing_next_operations_read:
  ...
  sha: 533e7292c445ff5b3e3504de6cfca929f0366467
...
- L3は問題番号範囲と問題数で管理する。
- 既存Active operations / Next operationsを基準線とし、遅延分だけを差分調整する。
- 2026-05-06はGW最終日・祝日扱いのためL3を実施できる。
