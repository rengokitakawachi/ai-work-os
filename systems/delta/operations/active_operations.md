...
- task: 2026-04-30 平日バージョン：国民年金法 L1 6章完了 + L2 P148〜P157
  source_ref:
  ...
  why_now:
    ...
    - P160は節の途中で区切りが悪いため、L2標準ラインをP157までに修正する
  notes:
    - 最低ライン: 秒トレ40問 + L1 国民年金法6章完了
    - 標準ライン: L1 国民年金法6章完了 + L2 基礎テキスト P148〜P157
    - 余力ライン: L2 基礎テキスト P165まで
    - L2最低ライン: P148〜P154まで進める
    - P158以降は併給の調整以降の次ブロックとして扱う
...
- L2 標準ラインは国民年金法 基礎テキスト P148〜P157。
- L2 余力ラインは P165まで。
- P160は中途半端な位置のため目標区切りにしない。
- L3 は問題番号ベースで管理する。
- L3 は各問題に理解度主軸で ◎ / ○ / △ / × を付ける。
- 正答数・正誤は補助情報として記録する。
- 評価記号は正答数から自動決定しない。
