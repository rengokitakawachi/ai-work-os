...
- todoist_projection_status: applied_then_manual_phase0_priority_reroute
...
Capacity note: 約2h。ADAM Phase 0 早期完了を優先し、intake routing 実運用を先に閉じる。
...
Capacity note: 約2h。ADAM Phase 0 の残りである design routing と report gate を優先する。
