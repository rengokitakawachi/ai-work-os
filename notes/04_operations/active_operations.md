...
- todoist_projection_status: applied_manual_safe_path
- todoist_projection_note:
  - projectTasks dry_run was run
  - dry_run proposed delete for completed 2026-05-17 weekly review task
  - apply was not used because delete / close semantics remain ambiguous
  - manual close / update / create was used instead
...
- notes:
  ...
  - Todoist projection was applied once after weekly reroll.
...
- task: Sunday Weekly Review Mode を実行する
  ...
  external:
    todoist_task_id: 6gg4CmvCMp4wgJFq
