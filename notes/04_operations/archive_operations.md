...
Invalid snapshot note:

- `notes/99_archive/operations/2026-05-10_weekly_operations.md` was mistakenly created during 2026-05-09 daily review and marked `superseded_mistaken_creation`. It must not be treated as a valid weekly snapshot.
