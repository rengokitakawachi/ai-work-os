...
- Phase 0 plan に属する骨格整理を、個別機能追加より優先する
...
- [x] Phase 0 の common operating model plan を作成する
  - ref: notes/03_plan/2026-04_phase0_adam_to_eve_common_operating_model.md
