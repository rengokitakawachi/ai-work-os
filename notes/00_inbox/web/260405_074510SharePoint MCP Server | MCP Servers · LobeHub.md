https://lobehub.com/ja/mcp/sofias-ai-mcp-sharepoint

![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg) ![PyPI version](https://badge.fury.io/py/mcp-sharepoint.svg)
...
Shell
    ...
    This project is licensed under the MIT License - see the [LICENSE](https://github.com/Sofias-ai/mcp-sharepoint) file for details.
    ...
    Agentic pipeline that transforms ideas to revenue for solo founders and bootstrappers. Provides 42 structured tools guiding raw idea to validated revenue including market research, buyer personas, offer design, landing pages, email sequences, ad copy, traffic strategy, SEO content engine, revenue phase tracking, portfolio management, and unit economics. Requires setting ASSET_FACTORY_PROJECT_DIR environment variable to specify the project directory containing pipeline-state.json and learnings.json files.
